...
public class Demo extends JFrame implements JMapViewerEventListener {
    ...
    public Demo() {
        ...
        MapPolygon utvonal = new MapPolygonImpl(c(50, 35), c(20, 20), c(25, 10), c(55, 5));
        ...
        JLabel helpLabel = new JLabel("Jobb klik mozgat,\n "
                + "bal duplaklik vagy görgő zoomol.");
